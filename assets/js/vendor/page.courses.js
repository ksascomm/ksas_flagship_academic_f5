...
$j(document).ready(function(){
   ...
   $container.isotope({
        ...
        itemSelector: '.accordion dd',
        layoutMode : 'straightDown'
    });
    $container.isotope({ sortBy : 'course_number' });
    // filter buttons
	...
	//Setup quicksearch
    $j('#id_search').quicksearch('dl.accordion dd', {
    	delay: 100,
    	bind: 'onchange keyup',
		noResults: '#noresults',
        'show': function() {
 ...
 $j('dl.accordion').on('click', 'dd', function () {
        setTimeout(function () {
...
$j(".acc_expandall").toggle(function() {
					...
					$j("dd .content").addClass("active");
					$container.isotope('reLayout')
				}, function() {
					$j(this).text("[Expand All]").stop();
					$j("dd .content").removeClass("active");
					$container.isotope('reLayout')
				});
});