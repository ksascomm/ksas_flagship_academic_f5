			...
			<?php endwhile; endif;  ?>
					<div id="fields_search" class="panel radius10">			
						<div class="row filter option-set" data-filter-group="term">
								...
								<div class="button radio"><a href="#" data-filter=".Intersession" onclick="ga('send', 'event', 'ISIS', 'Courses', 'Intersession');">Intersession 2018 Courses</a></div>
								<div class="button radio"><a href="#" data-filter=".Spring" onclick="ga('send', 'event', 'ISIS', 'Courses', 'Spring');">Spring 2018 Courses</a></div>
