				...
				<?php if ( get_post_meta($post->ID, 'ecpt_pub_role', true)) :?>, <?php echo get_post_meta($post->ID, 'ecpt_pub_role', true); endif; ?></a></b>
				<?php if (get_post_meta($post->ID, 'ecpt_author_cond', true) == 'on') { ?><br></b>
