...
$google_url = 'http://scholar.google.com/citations?user=' . $google_id . '&view_op=list_works&sortby=pubdate&pagesize=10';
...
echo '<p><strong>Displaying the 10 most recent publications. (Please refresh the page if no publications initially appear.)</p>'; 
...
foreach($google->find('tr.gsc_a_tr') as $article) {
    ...
    <p><?php echo $item['year']; ?>, <?php echo $item['pub']; ?></p>
